...
## 🌍 Sobre o Projeto:
O projeto playground functions como o prórpio nome diz, é um parque de funções em Javascript, neste projeto realizado durante o curso da trybe, o obketivo foi colocar todo conhecimento obtido sobre funções,objetos, arrays, estruturas de repetição e estruturas condicionais em prática, abaixo estão os requisitos realizados durante o projeto, e uma imagem mostrando o percentual de requisitos completos.
